...
The Signal Registry is the canonical vocabulary used throughout the project.
...
The Signal Registry is used by:
...
A Diagnostic Code is a standardized identifier generated by a control system to report an abnormal condition or detected malfunction.

A Diagnostic Code represents the interpretation of one or more observations performed by a controller.

It is not a direct observation.

## Purpose

Provide additional diagnostic evidence that may assist causal reasoning.

Diagnostic Codes never constitute proof of a root cause.

## Relationships

Diagnostic Codes may reference:

* Canonical Signals
* Events
* Behavioral Patterns

They contribute to causal hypotheses but never replace observations.
...
The Diagnostic Code Registry is the official DSCA knowledge base describing standardized Diagnostic Codes.

Each Diagnostic Code definition may include:

* Description
* Related Canonical Signals
...
Provide structured diagnostic knowledge while remaining independent from any specific manufacturer implementation.

The Registry assists reasoning.

The Registry complements observations.

It never replaces them.

It never determines conclusions.
...
The Experiment Registry is the official DSCA knowledge base describing diagnostic experiments used to validate or invalidate hypotheses.

## Purpose

Provide reusable validation procedures for causal reasoning.

Experiments transform plausible hypotheses into validated knowledge.
